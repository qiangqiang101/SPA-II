...
#Region "High End Apartments"
            ...
            With eclipseTowersPH2
                ...
                .EnterCam = New CameraPRH(New Vector3(-780.251F, 338.097F, 196.6879F), New Vector3(-3.25282F, 0F, -24.89274F), 50.0F)
                .ExitCam = New CameraPRH(New Vector3(-780.1199F, 342.116F, 196.6862F), New Vector3(-1.453532F, 0F, -157.3254F), 50.0F)
                .GarageElevatorPos = Vector3.Zero
                .GarageMenuPos = Vector3.Zero
                .ApartmentType = eApartmentType.IPL
                .Door = .IPL.GetEclipseTowersPenthouseDoor
            ...
            With eclipseTowersPH3
                ...
                .EnterCam = New CameraPRH(New Vector3(-780.7587F, 319.8445F, 187.9154F), New Vector3(-1.787759F, 0F, 149.9889F), 50.0F)
                .ExitCam = New CameraPRH(New Vector3(-780.8256F, 315.5568F, 187.9134F), New Vector3(-0.6143093F, 0F, 22.50142F), 50.0F)
                .GarageElevatorPos = Vector3.Zero
                .GarageMenuPos = Vector3.Zero
                .ApartmentType = eApartmentType.IPL
                .Door = .IPL.GetEclipseTowersPenthouseDoor
